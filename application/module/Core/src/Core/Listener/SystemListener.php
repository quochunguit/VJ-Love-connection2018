...
class SystemListener implements \Zend\EventManager\SharedListenerAggregateInterface, \Zend\ServiceManager\ServiceLocatorAwareInterface {

    protected $listeners = array();
    protected $serviceLocator;

    public function attachShared(\Zend\EventManager\SharedEventManagerInterface $events) {
        $this->listeners[] = $events->attach('*', \Zend\Mvc\MvcEvent::EVENT_ROUTE, array($this, 'onRoute'), 100);
    }

    function onRoute(\Zend\EventManager\EventInterface $event) {
