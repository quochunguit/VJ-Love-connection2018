        ...
        <script type="text/javascript">
            ...
            function initUploadFile_<?php echo $id; ?>() {
                ...
                var ajaxupload_<?php echo $id; ?> = new AjaxUpload(buttonz, {
                    action: '<?php echo BASE_URL; ?>/upload/admin_upload_video.php',
                    titleButton: 'Chi chap nhan tap tin video (.mp4, .flv)',
                    name: 'myfile',
                    onSubmit: function(file, ext) {
                        ext = ext.toUpperCase();
                        if (!(ext && /^(MP4|FLV)$/.test(ext))) {
                            alert('Chi chap nhan tap tin video (.mp4, .flv)');
                            return false;
                        } 
            ...
            <fieldset class="img_page" style="margin-top: 10px;">
                <table>
                    ...
                    <?php if ($files) { ?>
                        <tr>
                            <td colspan="2">
                                <p class="display_<?php echo $id; ?>"><a target="_blank" href="<?php echo $filePath . $files; ?>"> <?php echo $files; ?></a> </p>
