        ...
        <script type="text/javascript">
            ...
            function initUploadFile_<?php echo $id; ?>() {
                ...
                var ajaxupload_<?php echo $id; ?> = new AjaxUpload(buttonz, {
                    ...
                    titleButton: 'Chi chap nhan tap tin am thanh (.mp3)',
                    name: 'myfile',
                    onSubmit: function(file, ext) {
                        ext = ext.toUpperCase();
                        if (!(ext && /^(MP3)$/.test(ext))) {
                            alert('Chi chap nhan tap tin am thanh (.mp3)');
                            return false;
                        } 
