...
function _MakePWDWidget()
{
	...
	code += "<div class='pwdopsdiv' id='"+this.pwdshowdiv+"'><a href='javascript:;' id='"+this.pwdshow_anch+"'>"+this.txtShow+"</a></div>";

	this.pwdgendiv = pwdname+"_gendiv";

	this.pwdgenerate_anch = pwdname + "_gen_anch";

	code += "<div class='pwdopsdiv'id='"+this.pwdgendiv+"'><a href='javascript:;' id='"+this.pwdgenerate_anch+"'>"+this.txtGenerate+"</a></div>";
